  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="image/gagan.png" alt="image\_107317099_blooddonor976.jpg" width="100%" height="500">
      </div>
      <div class="carousel-item">
        <img src="image/fact2.png" alt="image\Blood-facts_10-illustration-graphics__canteen.png" width="100%" height="500">
      </div>
...
<br>
        ...
        <h2 style="text-align:center;">Blood Donor Names</h2>
...
<br>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <img class="img-fluid rounded" src="image/groups.png" alt="" >
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#7FB3D5;color:#273746;margin:20% 0">Become a Donor </a>
            </div>
        </div>
